...
function CheckInRow({ item }: { item: CheckInItem }) {
  return (
    <li className="rounded-[18px] border border-white/[0.08] bg-white/[0.035] p-4">
      ...
      {item.note && <p className="mt-2 text-[13px] font-medium leading-5 text-[#9CA2AE]">{item.note}</p>}
    </li>
  );
}
