  ...
  return (
    <main className="flex min-h-screen-safe items-center justify-center bg-[#0A0A0E] px-6 text-center text-white">
      <div className="max-w-sm space-y-3">
        ...
        <h1 className="text-2xl font-semibold">You are offline — check your connection</h1>
        <p className="text-sm leading-6 text-white/70">Cached venues may still be available when you return to the app.</p>
      </div>
    </main>
  );
}
