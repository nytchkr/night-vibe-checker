...
export default function VenueError({
  ...
  return (
    <main className="flex min-h-screen-safe flex-col items-center justify-center bg-[#0A0A0E] px-6 text-center font-sans text-white">
      <p className="font-display text-sm font-black uppercase tracking-normal text-[#8B6CFF]">Venue</p>
      ...
      <p className="mt-3 max-w-sm text-sm font-medium leading-6 text-white/60">
        We could not load this spot right now. Try again or return to the map.
      </p>
