    ...
    <div className="pointer-events-none fixed inset-x-4 top-4 z-[10000] flex justify-center text-white">
      <div className="pointer-events-auto flex w-full max-w-xl items-center justify-between gap-4 rounded-2xl border border-white/[0.08] bg-[#0A0A0E]/92 px-4 py-3 shadow-[0_0_28px_rgba(139,108,255,0.2)] backdrop-blur-md">
        ...
        <button
          type="button"
          onClick={dismiss}
          className="inline-flex min-h-11 shrink-0 items-center justify-center rounded-full bg-[#8B6CFF] px-4 text-xs font-black text-[#0A0A0E] shadow-[0_0_18px_rgba(240,86,140,0.24)] transition hover:bg-[#A896FF] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8B6CFF]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0E]"
        >
          Dismiss
        </button>
      </div>
